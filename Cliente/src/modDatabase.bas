...
Dim FileName As String
    ...
    With GameSetting
        ...
        '//Video
        .Resolution = GetVar(FileName, "Video", "Resolution")
        .Fullscreen = GetVar(FileName, "Video", "Fullscreen")
        BackUpRes = GameSetting.Resolution

        '//Network
        '.RemoteHost = Trim$(GetVar(FileName, "Network", "RemoteHost"))
        '.RemotePort = GetVar(FileName, "Network", "RemotePort")
        .RemoteHost = "localhost"
        '.RemoteHost = "198.50.185.93"
        .RemotePort = 8007
...
Dim FileName As String
    ...
    With GameSetting
        ...
        '//Video
        Call PutVar(FileName, "Video", "Resolution", Str(BackUpRes))
        Call PutVar(FileName, "Video", "Fullscreen", Str(.Fullscreen))
        
        '//Network
        'Call PutVar(FileName, "Network", "RemoteHost", Trim$(.RemoteHost))
        'Call PutVar(FileName, "Network", "RemotePort", Str(.RemotePort))
...
Public Sub ResetGui()
    ...
    '//BUTTONS
    With Button(ButtonEnum.Menu_Website)
        .X = Screen_Width - .Width - 10
        .Y = Screen_Height - .Height - 50 - (24 + 5)
    End With
    With Button(ButtonEnum.Menu_Register)
        .X = Screen_Width - .Width - 10
        .Y = Screen_Height - .Height - 50
    End With
    With Button(ButtonEnum.Menu_ChangePass)
        .X = Screen_Width - .Width - 10
        .Y = Screen_Height - .Height - 50
    End With
...
Dim FileName As String
    ...
    If FileExist(FileName) Then
        For i = 1 To ButtonEnum.Button_Count - 1
            Select Case i
                Case ButtonEnum.Menu_Website: FileTitle = "Menu_Website"
                Case ButtonEnum.Menu_Register: FileTitle = "Menu_Register"
                Case ButtonEnum.Menu_ChangePass: FileTitle = "Menu_ChangePass"
                ...
                Case ButtonEnum.Chatbox_Send: FileTitle = "Chatbox_Send"
...
Dim i As Long
    ...
    'End If
    '//Static
    tmpCreditText = "#h PokeNew Team//#h Owner/Wolf//#h Head Programmer/Seruwin//#h Developers/QrystalWave//#h Moderators/Bradley///#h Special Thanks/Genusis/Kibbelz"
