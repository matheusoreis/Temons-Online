...
Dim SetWidth As Long
    ...
    ServerName(1) = "Normal Server"
    ServerIP(1) = "167.114.51.119"
    ServerPort(1) = 8007
    
    ServerName(2) = "Fast Server"
...
Public Function CanShowButton(ByVal ButtonNum As ButtonEnum) As Boolean
    ...
    Select Case ButtonNum
        Case ButtonEnum.Menu_Website To ButtonEnum.Menu_Register
            If GUI(GuiEnum.GUI_CHARACTERSELECT).Visible Then CanShowButton = False
            If GUI(GuiEnum.GUI_CHARACTERCREATE).Visible Then CanShowButton = False
            If IsLoading Then CanShowButton = False
            If Fade Then CanShowButton = False
        Case ButtonEnum.Menu_ChangePass
            If Not GUI(GuiEnum.GUI_CHARACTERSELECT).Visible Then CanShowButton = False
            If GUI(GuiEnum.GUI_CHARACTERCREATE).Visible Then CanShowButton = False
            If IsLoading Then CanShowButton = False
            If Fade Then CanShowButton = False
