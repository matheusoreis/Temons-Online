...
Public Const chatScrollX As Long = 0
Public Const chatScrollTop As Long = 19
Public Const chatScrollW As Long = 19
Public Const chatScrollH As Long = 35
Public Const chatScrollL As Long = 61
Public Const ChatOffsetX As Long = 22
...
Public Sub RenderText(ByRef theFont As CustomFont, ByVal Text As String, ByVal X As Long, ByVal Y As Long, ByVal Color As Long, Optional ByVal isColorSet As Boolean = True, Optional ByVal Alpha As Long = 255)
