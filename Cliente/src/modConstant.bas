...
'//Map Constant
Public Const MAX_MAP As Long = 100
...
'//Language
Public Const LANG_EN As Byte = 0
Public Const LANG_AR As Byte = 1
...
Public Const Default_ScreenWidth As Long = 800
Public Const Default_ScreenHeight As Long = 600
